...
public final class ConversationViewModel {
    ...
    private func sendPrepared(modelText: String, displayText: String, sessionID sid: String) async -> Bool {
        ...
        let modelPayload = AttachmentStagingRules.promptAppending(refs: refTexts, to: modelText)
        let displayPayload = AttachmentStagingRules.promptAppending(refs: refTexts, to: displayText)
        guard !modelPayload.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty else { return false }
